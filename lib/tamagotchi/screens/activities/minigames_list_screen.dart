...
import 'catch_the_impostor_screen.dart';
import 'emotions_screens_game.dart';

/// Pantalla que muestra la lista de mini-juegos disponibles
                  ...
                  Expanded(
                    child: ListView(
                      ...
                      children: [
                        _buildGameCard(
                          ...
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const CatchTheImpostorScreen(),
                              ),
                            );
                          },
                        ),
                        ...
                        _buildGameCard(
                          context,
                          title: 'Emotions & Screens',
                          icon: Icons.emoji_emotions_outlined,
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const EmotionsScreensGame(),
                              ),
                            );
                          },
                        ),
